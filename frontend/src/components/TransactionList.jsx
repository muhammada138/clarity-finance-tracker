...
function TransactionList({ transactions, loading }) {
  ...
  const sorted = useMemo(() => {
    // Optimization: Removed O(N) category counting loop that was calculating an unused catCounts object.
    // This slightly improves performance when sorting or re-rendering by avoiding unnecessary iterations and allocations.
